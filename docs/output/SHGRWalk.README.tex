...
\begin{center}\includegraphics[width=0.3\linewidth]{./figs/SGRW-8class-map-annotated} \includegraphics[width=0.3\linewidth]{./figs/SGRW-11class-map-annotated} \includegraphics[width=0.3\linewidth]{./figs/SGRW-20class-map-annotated} \end{center}
...
\includegraphics{SHGRWalk.README_files/figure-latex/unnamed-chunk-3-1.pdf} \includegraphics{SHGRWalk.README_files/figure-latex/unnamed-chunk-3-2.pdf} \includegraphics{SHGRWalk.README_files/figure-latex/unnamed-chunk-3-3.pdf}
